# Proper working calculation all three equations and giving actual and approximate graph
...
class Application(tk.Tk):
    ...
    def solve_equation(self):
        ...
        if equation == "Heat Conduction":
            solution, x, y, exact_solution  = heat_conduction(input_values)
        elif equation == "Wave Equation":
            solution, x, y, exact_solution  = wave_equation(input_values)
        elif equation == "Fluid Flow":
            solution, x, y, exact_solution = fluid_flow(input_values[:3])  # Pass only the first three values
...
def heat_conduction(input_values):
    ...
    return solution, x, y, exact_solution 
