...
prompt = {'Initial Velocity (m/s):', 'Launch Angle (degrees):', 'Type of Drag Force (0: Zero Drag, 1: Linear Drag, 2: Quadratic Drag):'};
dlgtitle = 'Projectile Motion Parameters';
dims = [1 50];
definput = {'10', '45', '0'};
input_values = inputdlg(prompt, dlgtitle, dims, definput);

velocity = str2double(input_values{1});
angle = str2double(input_values{2});
drag_type = str2double(input_values{3});
